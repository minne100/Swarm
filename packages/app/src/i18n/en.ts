export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Swarm",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Swarm.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Swarm Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Swarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Swarm.",
  ...
  "dialog.server.description": "Switch which Swarm server this app connects to.",
  ...
  "toast.update.description": "A new version of Swarm ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Swarm team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Swarm does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Swarm includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Swarm server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Swarm",
  ...
  "settings.general.row.appearance.description": "Customise how Swarm looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Swarm follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Swarm is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Swarm launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Swarm.",
